...
const routes = new Map([
  ["/services", "Services"],
  ["/services/cloud-hebergement", "Hébergement & services en ligne"],
  ["/services/domaines-messagerie", "Nom de domaine & messagerie"],
  ["/services/reseau-securite", "Réseau & Sécurité"],
  ["/services/support-it", "Assistance & maintenance"],
  ["/services/vps", "VPS"],
