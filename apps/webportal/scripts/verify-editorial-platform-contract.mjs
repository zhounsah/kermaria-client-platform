...
assert.match(seoPage, /className="seo-editorial-summary"/);
assert.doesNotMatch(seoPage, /className="eyebrow">\{page\.summary\}/);
assert.match(seoHubPage, /getPublicEditorialSitemap/);
assert.match(seoHubPage, /contentType === "seo_page"/);
assert.match(seoHubPage, /categoryName/);
assert.match(seoHubPage, /categorySortOrder/);
assert.match(seoHubPage, /Number\.MAX_SAFE_INTEGER/);
assert.match(seoHubPage, /first\.sortOrder - second\.sortOrder/);
assert.match(seoHubPage, /sortOrder/);
assert.doesNotMatch(seoHubPage, /back-office/i);
...
assert.doesNotMatch(adminForm, /contentType !== "seo_page"/);
assert.doesNotMatch(adminList, /contentType !== "seo_page"/);
assert.match(adminList, /item\.categoryName/);
