...
export const demoClientSpace = {
  ...
  summary: {
    ...
    storageTotal: "32 Go",
    storagePercent: 54,
    backupStatus: "Protege",
    lastBackup: "Aujourd'hui a 03:12",
    openTickets: 1,
    dueInvoices: 0,
  },
  subscription: {
    ...
    setupFee: "0,00 EUR",
    services: "Tous les services du pack actives",
    history: [
      "14/01/2026 - Souscription initiale validee",
      "01/03/2026 - Extension de stockage incluse activee",
      "01/06/2026 - Verification annuelle de securite planifiee",
    ],
  },
  services: [
    {
      ...
      summary: "32 Go de stockage securise inclus pour les documents de l'association.",
      status: "active",
    ...
    },
    {
      ...
      summary: "Sauvegarde quotidienne avec retention de 31 jours.",
      status: "active",
      included: "Derniere sauvegarde reussie aujourd'hui",
    },
    {
      id: "support",
      name: "Assistance informatique",
      summary: "Support pour les demandes liees aux services du compte.",
      status: "active",
    ...
    },
    {
      ...
      summary: "Creation, suivi et roles des utilisateurs rattaches au compte.",
      status: "active",
      included: "6 utilisateurs actifs",
    },
    {
      id: "vpn",
      name: "Acces distant securise",
      summary: "Acces distant securise pour les membres autorises.",
      status: "active",
      included: "3 acces autorises",
    },
    {
      id: "remote-desktop",
      name: "Bureau distant",
      summary: "Acces distant au poste ou a l'environnement gere.",
      status: "active",
      included: "2 sessions recentes",
    },
    {
      id: "nextcloud",
      name: "Acces web aux documents",
      summary: "Consultation des documents partages depuis le navigateur.",
      status: "active",
      included: "Synchronisation active",
    },
    {
      id: "security",
      name: "Securite du compte",
      summary: "Double authentification, sessions et controles de connexion.",
      status: "active",
    ...
    },
    {
      ...
      summary: "Demande assistee de restauration depuis une sauvegarde disponible.",
      status: "active",
    ...
    },
    {
      ...
      summary: "Factures, echeances et suivi du pack souscrit.",
      status: "active",
      included: "Aucune facture a payer",
    },
  ...
  storage: {
    ...
    history: [
      ...
      { month: "Aout", value: 17.4 },
    ],
    folders: [
      "Administration",
      "Comptabilite / Factures 2026",
      "Evenements",
      "Photos adherents",
      "Archives du bureau",
    ],
  ...
  backups: {
    status: "Protege",
    lastRun: "Aujourd'hui a 03:12",
    lastSuccess: "Aujourd'hui a 03:12",
    protectedData: "17,4 Go",
    retention: "31 jours",
    nextRun: "Cette nuit",
    verification: "Aujourd'hui a 04:00",
    runs: [
      {
        date: "08/08/2026",
        result: "success",
      ...
      },
      {
        date: "05/08/2026",
        result: "warning",
        label: "Reussie avec avertissement",
        protectedData: "17,2 Go",
        duration: "22 min",
      },
      {
    ...
    restoreRequests: [
      {
        ...
        item: "Comptabilite / Factures 2026",
  ...
  users: [
    {
      ...
      status: "Actif",
      lastLogin: "Aujourd'hui a 09:14",
      services: ["Stockage", "Acces distant", "Facturation"],
    },
    {
      name: "Lucas Bernard",
      role: "Utilisateur",
    ...
    },
    {
      ...
      services: ["Stockage", "Acces distant"],
    },
  ] satisfies DemoUser[],
  tickets: [
    {
      ...
      messages: [
        {
          ...
          text: "Un fichier de comptabilite semble avoir ete supprime par erreur.",
        },
        {
          author: "Support Zachary IT",
          date: "08/08/2026 10:05",
          text: "Demande prise en charge. Verification de la version du 06/08/2026 en cours.",
        },
      ],
    },
    {
      reference: "DEMO-1842",
      subject: "Demande d'acces pour un nouvel utilisateur",
      status: "Resolu",
      date: "05/08/2026",
      ...
      messages: [
        {
          ...
          text: "Merci d'ajouter un acces stockage pour un membre du bureau.",
        },
        {
          author: "Support Zachary IT",
          date: "05/08/2026 14:20",
          text: "Acces cree dans cette demonstration fictive.",
        },
      ],
    },
    {
      ...
      messages: [
        {
          ...
          text: "Le poste utilise pour l'accueil doit acceder aux documents partages.",
        },
        {
          author: "Support Zachary IT",
          date: "29/07/2026 15:35",
          text: "Configuration terminee et controlee.",
        },
      ],
    },
  ...
  security: {
    checks: [
      ...
      "Aucune connexion suspecte detectee",
      "Derniere verification : aujourd'hui a 04:00",
    ],
    logins: [
      {
  ...
  activity: [
    {
      ...
      text: "Claire Martin s'est connectee",
      type: "Connexion",
    },
    {
      time: "Aujourd'hui 03:12",
      text: "Sauvegarde terminee avec succes",
      type: "Sauvegarde",
    },
    {
      time: "Hier 17:42",
      text: "Lucas Bernard s'est connecte",
      type: "Connexion",
    },
    {
      time: "07/08/2026",
      text: "Facture de juillet enregistree comme payee",
      type: "Facturation",
    },
    {
      time: "06/08/2026",
      text: "Nouvel utilisateur ajoute",
      type: "Utilisateurs",
    },
  ],
  notifications: [
    {
      title: "Sauvegarde reussie cette nuit",
      message: "Vos donnees sont protegees avec la sauvegarde du 08/08/2026.",
      tone: "success",
    },
    {
      title: "Nouvelle facture disponible",
      message: "La facture FAC-DEMO-2026-008 est consultable dans la demo.",
      tone: "info",
    },
    {
