#
> Current deployed example - 2026-08-27: `v2.0.0.4` / `b66e89d`, active release `/opt/kermaria/releases/20260827-111656-v2.0.0.4-b66e89d`. The generic procedure below remains valid.
