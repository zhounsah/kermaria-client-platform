#
> Current deployed example - 2026-08-27: `v2.0.0.5` / `a6eefcd`, active release `/opt/kermaria/releases/20260827-191145-v2.0.0.5-a6eefcd`. The generic procedure below remains valid.
